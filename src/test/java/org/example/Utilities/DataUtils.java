...
public class DataUtils {
    ...
    public static void setDataToProperties(String key, String value) throws IOException {
        Properties prop = new Properties();
        FileInputStream in = new FileInputStream(TEST_DATA_PATH + "enviroment.properties");
        prop.load(in);
        in.close();

        FileOutputStream out = new FileOutputStream(TEST_DATA_PATH + "enviroment.properties");
